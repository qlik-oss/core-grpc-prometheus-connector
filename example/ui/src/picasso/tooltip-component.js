module.exports = {
  // The require property allows us to pull in our dependencies, in this case the chart instance
  // for shape lookups and the renderer for rendering our nodes.
  require: ['chart', 'renderer'],
  // A component can define a set of default properties that expose in the current context. In
  // our case we'll just allow some simple style related properties to be set by the users.
  defaultSettings: {
    background: '#f9f9f9',
    fontSize: '12px',
  },
  // We require a particular type of renderer, the available once are svg/canvas/dom. Since we want
  // to do be able do CSS layouting we'll use the dom-renderer. It's available in the
  // context as `renderer`.
  renderer: 'dom',
